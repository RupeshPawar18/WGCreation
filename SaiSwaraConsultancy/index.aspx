<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="index" MasterPageFile="~/saiswara.master" %>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
   ...
   <div class="carousel-inner">
       <div class="item active  ">
        <a href="#"><img src="images/Image_BigSize.jpg" alt="" class="img-responsive  hidden-xs"  style="width:100%;"></a>
           <a href="#"><img src="images/Image_BigSizeM.jpg" alt="" class="img-responsive hidden-lg hidden-md hidden-sm" ></a>
      </div>
...
<div class="container saiswarapost">
  ...
  <form class="form-inline">
      <div class="form-group">
          ...
          <asp:TextBox ID="txtCName" runat="server"  placeholder="Candidate Name" class="form-control form-txt postr"></asp:TextBox>
                    
    </div>
    <div class="form-group">
      
        <asp:TextBox ID="txtCEmail" runat="server"  placeholder="Candidate Email ID" class="form-control form-txt postr"></asp:TextBox>
    </div>
	<div class="form-group">
      
        <asp:TextBox ID="txtCNumber" runat="server"  placeholder="Contact No." class="form-control form-txt postr" MaxLength="10"></asp:TextBox>
    </div>
	<div class="form-group">
  ...
  <%--<div class="text-center"><button type="submit" class="btn button1 ">Submit</button></div>--%>
      <div class="form-group">
          <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btn button1" OnClick="btnSubmit_Click" /> <%--ValidationGroup="PartnerProfileUpdate" />--%>
      </div>
...
<div class="row">
    ...
    <div class="row">
        <div class="container">
            <div class="saiabt">
            <div class="col-sm-2"><img src="images/saiswara_logo.png" class="img-responsive logo  wow bounceInLeft" data-wow-duration="3s"></div>
    ...
    <div class="container" id="whyus">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 br1 wow zoomIn" data-wow-duration="3s" >
                <p><img src="images/data.jpg" class="img-responsive icon"></p>
...
<p><img src="images/approach.jpg" class="img-responsive icon"></p>
<p class="icon-subtitle">Professional Approach</p>
<p class="icon-para">Saiswara Consultancy and Services has a team of professionals<br />  
who are experts in identifying, short listing the candidates as per the client<br /> 
 ...
 and competence to meet all your requirements</p>
</div>
<div class="col-sm-6 wow zoomIn" data-wow-duration="3s">
<p><img src="images/assured.jpg" class="img-responsive icon"></p>
<p class="icon-subtitle">Assured Confidentiality</p>
<p class="icon-para">We maintain the highest level of conﬁdentiality<br />  
of information about client organizations and candidates.<br /> 
We follow the best business practices and maintain high ethical standards</p>
</div>
</div>
</div>
</section>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 wow fadeInUp" data-wow-duration="100s">
        <div class="owl-carousel owl-theme">
  <div class="item">
                <p><img src="images/oil&gas_enng.jpg" class="img-responsive pT10"></p>
            ...
            <div class="item">
             ...
             <div class="item">
                <p><img src="images/engineering.jpg" class="img-responsive pT10"></p>
               ...
               <div class="item">
                <p><img src="images/detail.jpg" class="img-responsive pT10"></p>
            ...
            <div class="item">
                <p><img src="images/engineering1.jpg" class="img-responsive pT10"></p>
        ...
        <div class="row">
            ...
            <div class="col-sm-5 wow fadeInUp" data-wow-duration="3s">
               <h2 class="icon-title cont">HOW TO <span>FIND US</span></h2>
                ...
                <p class="contact-text">If you have any questions, just fill in the contct form, and we will answer you shortly.</p>
                <h3 class="pT50">Office Address</h3>
                <p class="contact-text pT10">
                   Riverwood park Building No.-12/ Flat No. 506, <br />
